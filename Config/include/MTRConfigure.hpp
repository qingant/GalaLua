    ...
    public:
        ...
        PLuaEnvList get_MonitorList_Monitor_LuaEnvList(int32_t LuaEnvListIdx);
        PBYTE get_MonitorList_Monitor_LuaEnvList_Usable(int32_t LuaEnvListIdx);
        void set_MonitorList_Monitor_LuaEnvList_Usable(int32_t LuaEnvListIdx,bool Enable,bool isLoad = false);
        PBYTE get_MonitorList_Monitor_LuaEnvList_LuaEnv_Path(int32_t LuaEnvListIdx);
        void set_MonitorList_Monitor_LuaEnvList_LuaEnv_Path(int32_t LuaEnvListIdx,PBYTE Path);
        PBYTE get_MonitorList_Monitor_LuaEnvList_LuaEnv_Usable(int32_t LuaEnvListIdx);
        void set_MonitorList_Monitor_LuaEnvList_LuaEnv_Usable(int32_t LuaEnvListIdx,bool Enable,bool isLoad = false);
        ...
        PBYTE get_MonitorList_Monitor_Base_AMQToken();
        void set_MonitorList_Monitor_Base_AMQToken(PBYTE AMQToken);
        PBYTE get_MonitorList_Monitor_Base_RTToken();
        void set_MonitorList_Monitor_Base_RTToken(PBYTE RTToken);
        ...
        void set_MonitorList_Monitor_LowLoger(LevelType::LevelType LowLoger);
        PAppLoger get_MonitorList_Monitor_AppLoger();
        PBYTE get_MonitorList_Monitor_AppLoger_Level();
        void set_MonitorList_Monitor_AppLoger_Level(LevelType::LevelType Level);
        PBYTE get_MonitorList_Monitor_AppLoger_Details();
        void set_MonitorList_Monitor_AppLoger_Details(Switch::Switch Details);
        PBYTE get_MonitorList_Monitor_AppLoger_Size();
        void set_MonitorList_Monitor_AppLoger_Size(int32_t Size);
        PBYTE get_MonitorList_Monitor_AppLoger_Files();
        void set_MonitorList_Monitor_AppLoger_Files(int32_t Files);
        PBYTE get_MonitorList_Monitor_AppLoger_Dir();
        void set_MonitorList_Monitor_AppLoger_Dir(PBYTE Dir);
        PBYTE get_MonitorList_Monitor_AppLoger_NameFormat();
        void set_MonitorList_Monitor_AppLoger_NameFormat(AppLogNameType::AppLogNameType NameFormat);
        PBYTE get_MonitorList_Monitor_AppLoger_DirFormat();
        void set_MonitorList_Monitor_AppLoger_DirFormat(AppLogDirType::AppLogDirType DirFormat);
        ...
        PBYTE get_MonitorList_Monitor_SVC_MaxProcess();
        void set_MonitorList_Monitor_SVC_MaxProcess(int32_t MaxProcess);
        ...
        PCTR get_MonitorList_Monitor_CTR();
        PBYTE get_MonitorList_Monitor_CTR_Address_IP();
        void set_MonitorList_Monitor_CTR_Address_IP(PBYTE IP);
        PBYTE get_MonitorList_Monitor_CTR_Address_Port();
        void set_MonitorList_Monitor_CTR_Address_Port(int32_t Port);
        PBYTE get_MonitorList_Monitor_CTR_Address_Usable();
        void set_MonitorList_Monitor_CTR_Address_Usable(bool Enable,bool isLoad = false);
        PBYTE get_MonitorList_Monitor_CTR_Usable();
        void set_MonitorList_Monitor_CTR_Usable(bool Enable,bool isLoad = false);
