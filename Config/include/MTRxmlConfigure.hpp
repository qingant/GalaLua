    ...
    public:
        ...
        void OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__SCROLLTYPE(xmlNodePtr node,const std::string &path);
        void InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__SCROLLTYPE(const std::string &path0,const std::string &path1);
        void OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR(xmlNodePtr node,const std::string &path);
        void InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR(const std::string &path0,const std::string &path1);
        void InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_Usable(const std::string &path);
        void OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE(xmlNodePtr node,const std::string &path);
        void InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE(const std::string &path0,const std::string &path1);
        void InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE_Usable(const std::string &path);
        void OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE_NamePattern(xmlNodePtr node,const std::string &path);
        void InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE_NamePattern(const std::string &path0,const std::string &path1);
        void OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE(xmlNodePtr node,const std::string &path);
        void InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE(const std::string &path0,const std::string &path1);
        void InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE_Usable(const std::string &path);
        void OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE_NamePattern(xmlNodePtr node,const std::string &path);
        void InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE_NamePattern(const std::string &path0,const std::string &path1);
        void OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE(xmlNodePtr node,const std::string &path);
        void InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE(const std::string &path0,const std::string &path1);
        void InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE_Usable(const std::string &path);
        void OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE_NamePattern(xmlNodePtr node,const std::string &path);
        void InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE_NamePattern(const std::string &path0,const std::string &path1);
