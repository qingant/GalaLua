...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor(xmlNodePtr node,const string &path)
{
    ...
    string subpath;
    xmlNodePtr child = NULL;
    child = xmlNewNode(NULL,BAD_CAST "LuaEnvLists");
    xmlAddChild(node,child);
    subpath = path;
    subpath += "/";
    subpath += "LuaEnvList";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvLists(child,subpath);
    ...
    child = xmlNewNode(NULL,BAD_CAST "CTR");
    xmlAddChild(node,child);
    subpath = path;
    subpath += "/";
    subpath += "CTR";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR(child,subpath);
...
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor(const string &path0,const string &path1)
{
    ...
    childPath0 = path0;
    childPath1 = path1;
    childPath0 += "/LuaEnvList";
    childPath1 += "/LuaEnvList";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvLists(childPath0,childPath1);
    childPath0 = path0;
    childPath1 = path1;
    childPath0 += "/Base";
    childPath1 += "/Base";
    ...
    childPath0 += "/CTR";
    childPath1 += "/CTR";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR(childPath0,childPath1);
    childPath0 = path0;
    childPath1 = path1;
    childPath0 += "/LSRList";
    childPath1 += "/LSRList";
...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvLists(xmlNodePtr node,const string &path)
{
    char idx[256];
    int items = 8;
    for(int ii =0 ; ii < items ; ++ii)
    {
        ...
        xmlAddChild(node,child);
        OutPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList(child,npath);
    };
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvLists(const string &path0,const string &path1)
{
    char idx[256];
    string childPath0;
    string childPath1;
    ...
    for(int ii =0 ; ii < items ; ++ii)
    {
        ...
        childPath1 += idx;
        childPath1 += "]";
        InPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList(childPath0,childPath1);
    };
}
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList(xmlNodePtr node,const string &path)
{
    string szTemp ;
    szTemp += path;
    szTemp += "/";
    ...
    string subpath;
    xmlNodePtr child = NULL;
    child = xmlNewNode(NULL,BAD_CAST "LuaEnv");
    xmlAddChild(node,child);
    subpath = path;
    subpath += "/";
    subpath += "LuaEnv";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList_LuaEnv(child,subpath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList(const string &path0,const string &path1)
{
    string childPath0;
    string childPath1;
    if(!IsExist(path0))
    ...
    childPath0 += "/LuaEnv";
    childPath1 += "/LuaEnv";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList_LuaEnv(childPath0,childPath1);
    string usablePath = path1;
    usablePath += "/Usable";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList_Usable(usablePath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList_Usable(const string &path){
    _ConfObject->Put(path,"1",true);
}
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList_LuaEnv(xmlNodePtr node,const string &path)
{
    string szTemp ;
    szTemp += path;
    szTemp += "/";
    ...
    string subpath;
    xmlNodePtr child = NULL;
    child = xmlNewNode(NULL,BAD_CAST "Path");
    xmlAddChild(node,child);
    subpath = path;
    subpath += "/";
    subpath += "Path";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList_LuaEnv_Path(child,subpath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList_LuaEnv(const string &path0,const string &path1)
{
    string childPath0;
    string childPath1;
    if(!IsExist(path0))
    ...
    childPath0 += "/Path";
    childPath1 += "/Path";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList_LuaEnv_Path(childPath0,childPath1);
    string usablePath = path1;
    usablePath += "/Usable";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList_LuaEnv_Usable(usablePath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList_LuaEnv_Usable(const string &path){
    _ConfObject->Put(path,"1",true);
}
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList_LuaEnv_Path(xmlNodePtr node,const string &path)
{
    xmlNodePtr content = xmlNewText(BAD_CAST _ConfObject->Get(path).c_str());
    xmlAddChild(node,content);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_LuaEnvList_LuaEnv_Path(const string &path0,const string &path1)
{
...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_Base(xmlNodePtr node,const string &path)
{
    ...
    child = xmlNewNode(NULL,BAD_CAST "AMQToken");
    xmlAddChild(node,child);
    subpath = path;
    subpath += "/";
    subpath += "AMQToken";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_Base_AMQToken(child,subpath);
    child = xmlNewNode(NULL,BAD_CAST "RTToken");
    xmlAddChild(node,child);
    subpath = path;
    subpath += "/";
    subpath += "RTToken";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_Base_RTToken(child,subpath);
...
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_Base(const string &path0,const string &path1)
{
    ...
    childPath0 += "/AMQToken";
    childPath1 += "/AMQToken";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_Base_AMQToken(childPath0,childPath1);
    childPath0 = path0;
    childPath1 = path1;
    childPath0 += "/RTToken";
    childPath1 += "/RTToken";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_Base_RTToken(childPath0,childPath1);
    childPath0 = path0;
    childPath1 = path1;
...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_Base_AMQToken(xmlNodePtr node,const string &path)
{
    xmlNodePtr content = xmlNewText(BAD_CAST _ConfObject->Get(path).c_str());
    xmlAddChild(node,content);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_Base_AMQToken(const string &path0,const string &path1)
{
    string childPath0 = path0;
    string childPath1 = path1;
    xmlNodePtr node = xmlXpath(childPath0);
...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_Base_RTToken(xmlNodePtr node,const string &path)
{
    xmlNodePtr content = xmlNewText(BAD_CAST _ConfObject->Get(path).c_str());
    xmlAddChild(node,content);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_Base_RTToken(const string &path0,const string &path1)
{
    string childPath0 = path0;
    string childPath1 = path1;
    xmlNodePtr node = xmlXpath(childPath0);
...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_SVC(xmlNodePtr node,const string &path)
{
    ...
    child = xmlNewNode(NULL,BAD_CAST "MaxProcess");
    xmlAddChild(node,child);
    subpath = path;
    subpath += "/";
    subpath += "MaxProcess";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_SVC_MaxProcess(child,subpath);
...
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_SVC(const string &path0,const string &path1)
{
    ...
    childPath0 = path0;
    childPath1 = path1;
    childPath0 += "/MaxProcess";
    childPath1 += "/MaxProcess";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_SVC_MaxProcess(childPath0,childPath1);
    childPath0 = path0;
    childPath1 = path1;
    childPath0 += "/IsFlush";
    childPath1 += "/IsFlush";
...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_SVC_MaxProcess(xmlNodePtr node,const string &path)
{
    xmlNodePtr content = xmlNewText(BAD_CAST _ConfObject->Get(path).c_str());
    xmlAddChild(node,content);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_SVC_MaxProcess(const string &path0,const string &path1)
{
    string childPath0 = path0;
    string childPath1 = path1;
    xmlNodePtr node = xmlXpath(childPath0);
...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR(xmlNodePtr node,const string &path)
{
    string szTemp ;
    szTemp += path;
    szTemp += "/";
    ...
    subpath += "/";
    subpath += "Address";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address(child,subpath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR(const string &path0,const string &path1)
{
    string childPath0;
    string childPath1;
    if(!IsExist(path0))
    ...
    childPath0 += "/Address";
    childPath1 += "/Address";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address(childPath0,childPath1);
    string usablePath = path1;
    usablePath += "/Usable";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Usable(usablePath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Usable(const string &path){
    _ConfObject->Put(path,"1",true);
}
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address(xmlNodePtr node,const string &path)
{
    string szTemp ;
    szTemp += path;
    szTemp += "/";
    ...
    subpath += "/";
    subpath += "IP";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address_IP(child,subpath);
    child = xmlNewNode(NULL,BAD_CAST "Port");
    xmlAddChild(node,child);
    subpath = path;
    subpath += "/";
    subpath += "Port";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address_Port(child,subpath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address(const string &path0,const string &path1)
{
    string childPath0;
    string childPath1;
    if(!IsExist(path0))
    ...
    childPath0 += "/IP";
    childPath1 += "/IP";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address_IP(childPath0,childPath1);
    childPath0 = path0;
    childPath1 = path1;
    childPath0 += "/Port";
    childPath1 += "/Port";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address_Port(childPath0,childPath1);
    string usablePath = path1;
    usablePath += "/Usable";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address_Usable(usablePath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address_Usable(const string &path){
    _ConfObject->Put(path,"1",true);
}
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address_IP(xmlNodePtr node,const string &path)
{
    xmlNodePtr content = xmlNewText(BAD_CAST _ConfObject->Get(path).c_str());
    xmlAddChild(node,content);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address_IP(const string &path0,const string &path1)
{
    string childPath0 = path0;
    string childPath1 = path1;
    xmlNodePtr node = xmlXpath(childPath0);
...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address_Port(xmlNodePtr node,const string &path)
{
    xmlNodePtr content = xmlNewText(BAD_CAST _ConfObject->Get(path).c_str());
    xmlAddChild(node,content);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_CTR_Address_Port(const string &path0,const string &path1)
{
    string childPath0 = path0;
    string childPath1 = path1;
    xmlNodePtr node = xmlXpath(childPath0);
