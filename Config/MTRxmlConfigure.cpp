...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger(xmlNodePtr node,const string &path)
{
    ...
    subpath += "/";
    subpath += "_SCROLLTYPE";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__SCROLLTYPE(child,subpath);
    child = xmlNewNode(NULL,BAD_CAST "_UNIONSELECTOR");
    xmlAddChild(node,child);
    subpath = path;
    subpath += "/";
    subpath += "_UNIONSELECTOR";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR(child,subpath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger(const string &path0,const string &path1)
{
    ...
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__SCROLLTYPE(childPath0,childPath1);
    childPath0 = path0;
    childPath1 = path1;
    childPath0 += "/_UNIONSELECTOR";
    childPath1 += "/_UNIONSELECTOR";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR(childPath0,childPath1);
    string usablePath = path1;
    usablePath += "/Usable";
...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__SCROLLTYPE(xmlNodePtr node,const string &path)
{
    xmlNodePtr content = xmlNewText(BAD_CAST _ConfObject->Get(path).c_str());
    xmlAddChild(node,content);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__SCROLLTYPE(const string &path0,const string &path1)
{
    string childPath0 = path0;
    string childPath1 = path1;
    xmlNodePtr node = xmlXpath(childPath0);
...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR(xmlNodePtr node,const string &path)
{
    string szTemp ;
    szTemp += path;
    szTemp += "/";
    ...
    switch(atoi(_ConfObject->Get(parentPath).c_str()))
    {
        ...
        {
            child = xmlNewNode(NULL,BAD_CAST "DATEMODE");
            xmlAddChild(node,child);
            subpath = path;
            subpath += "/";
            subpath += "DATEMODE";
            OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE(child,subpath);
            break;
        }
        case(LogType::APPMODE):
        {
            child = xmlNewNode(NULL,BAD_CAST "APPMODE");
            xmlAddChild(node,child);
            subpath = path;
            subpath += "/";
            subpath += "APPMODE";
            OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE(child,subpath);
            break;
        }
        case(LogType::CUSTOMMODE):
        {
            child = xmlNewNode(NULL,BAD_CAST "CUSTOMMODE");
            xmlAddChild(node,child);
            subpath = path;
            subpath += "/";
            subpath += "CUSTOMMODE";
            OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE(child,subpath);
            break;
        }
    }
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR(const string &path0,const string &path1)
{
    string childPath0;
    string childPath1;
    if(!IsExist(path0))
    ...
    if(NULL == scrollType)
    {
        THROW_EXCEPTION(1,"the child _SCROLLTYPE of AppLoger  do not exist");
    }
    char *value = Value(scrollType);
    if(NULL == value)
    {
        THROW_EXCEPTION(1,"the child _SCROLLTYPE of AppLoger  content is empty");
    }
    switch(atoi(value))
    {
        case(LogType::DATEMODE):
        {
            ...
            childPath0 += "/DATEMODE";
            childPath1 += "/DATEMODE";
            InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE(childPath0,childPath1);
            break;
        }
        case(LogType::APPMODE):
        {
            ...
            childPath0 += "/APPMODE";
            childPath1 += "/APPMODE";
            InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE(childPath0,childPath1);
            break;
        }
        case(LogType::CUSTOMMODE):
        {
            childPath0 = path0;
            childPath1 = path1;
            childPath0 += "/CUSTOMMODE";
            childPath1 += "/CUSTOMMODE";
            InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE(childPath0,childPath1);
            break;
        }
        default:
        {
    ...
    string usablePath = path1;
    usablePath += "/Usable";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_Usable(usablePath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_Usable(const string &path){
    _ConfObject->Put(path,"1",true);
}
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE(xmlNodePtr node,const string &path)
{
    string szTemp ;
    szTemp += path;
    szTemp += "/";
    ...
    string subpath;
    xmlNodePtr child = NULL;
    child = xmlNewNode(NULL,BAD_CAST "NamePattern");
    xmlAddChild(node,child);
    subpath = path;
    subpath += "/";
    subpath += "NamePattern";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE_NamePattern(child,subpath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE(const string &path0,const string &path1)
{
    string childPath0;
    string childPath1;
    if(!IsExist(path0))
    ...
    childPath0 = path0;
    childPath1 = path1;
    childPath0 += "/NamePattern";
    childPath1 += "/NamePattern";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE_NamePattern(childPath0,childPath1);
    string usablePath = path1;
    usablePath += "/Usable";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE_Usable(usablePath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE_Usable(const string &path){
    _ConfObject->Put(path,"1",true);
}
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE_NamePattern(xmlNodePtr node,const string &path)
{
    xmlNodePtr content = xmlNewText(BAD_CAST _ConfObject->Get(path).c_str());
    xmlAddChild(node,content);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_DATEMODE_NamePattern(const string &path0,const string &path1)
{
    string childPath0 = path0;
    string childPath1 = path1;
    xmlNodePtr node = xmlXpath(childPath0);
...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE(xmlNodePtr node,const string &path)
{
    string szTemp ;
    szTemp += path;
    szTemp += "/";
    ...
    subpath += "/";
    subpath += "NamePattern";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE_NamePattern(child,subpath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE(const string &path0,const string &path1)
{
    string childPath0;
    string childPath1;
    if(!IsExist(path0))
    ...
    childPath0 += "/NamePattern";
    childPath1 += "/NamePattern";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE_NamePattern(childPath0,childPath1);
    string usablePath = path1;
    usablePath += "/Usable";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE_Usable(usablePath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE_Usable(const string &path){
    _ConfObject->Put(path,"1",true);
}
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE_NamePattern(xmlNodePtr node,const string &path)
{
    xmlNodePtr content = xmlNewText(BAD_CAST _ConfObject->Get(path).c_str());
    xmlAddChild(node,content);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_APPMODE_NamePattern(const string &path0,const string &path1)
{
    string childPath0 = path0;
    string childPath1 = path1;
    xmlNodePtr node = xmlXpath(childPath0);
...
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE(xmlNodePtr node,const string &path)
{
    string szTemp ;
    szTemp += path;
    szTemp += "/";
    ...
    subpath += "/";
    subpath += "NamePattern";
    OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE_NamePattern(child,subpath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE(const string &path0,const string &path1)
{
    string childPath0;
    string childPath1;
    if(!IsExist(path0))
    ...
    childPath0 += "/NamePattern";
    childPath1 += "/NamePattern";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE_NamePattern(childPath0,childPath1);
    string usablePath = path1;
    usablePath += "/Usable";
    InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE_Usable(usablePath);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE_Usable(const string &path){
    _ConfObject->Put(path,"1",true);
}
void CXmlMonitorConfigure::OutPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE_NamePattern(xmlNodePtr node,const string &path)
{
    xmlNodePtr content = xmlNewText(BAD_CAST _ConfObject->Get(path).c_str());
    xmlAddChild(node,content);
}
void CXmlMonitorConfigure::InPut_Configure__STRUCTURE_MonitorLists_Monitor_AppLoger__UNIONSELECTOR_CUSTOMMODE_NamePattern(const string &path0,const string &path1)
{
    string childPath0 = path0;
    string childPath1 = path1;
    xmlNodePtr node = xmlXpath(childPath0);
